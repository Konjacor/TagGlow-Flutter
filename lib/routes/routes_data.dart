...
import '../pages/note/theme_selection_page.dart';
import '../pages/note/Note_list.dart';

final String initialRoute = RouteName.splashPage; // 初始默认显示的路由

final Map<String, Widget Function(BuildContext context, {dynamic params})>
    routesData = {
  // 页面路由定义...
  ...
  RouteName.notePage: (context, {params}) => NotePage(
        userId: '',
      ),
  ...
  RouteName.themeSelection: (context, {params}) => const ThemeSelectionPage(),
  RouteName.noteList: (context, {params}) => const NoteListPage(),
};
